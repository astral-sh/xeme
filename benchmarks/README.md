...
The [current project table](../README.md) uses only the buffered confirmation 4 KiB/namespaces-off rows. Initial Python builds two fresh candidate modules and reuses four controls; confirmation reuses all six modules and compiles none.
