...
use xeme_storage::{AllocError, Allocator, String, Vec};
...
mod tests {
    ...
    fn initial_reservation_only_changes_the_first_nonempty_append() {
        let mut buffer = super::Buffer::new_in(xeme_storage::Allocator::System);
        ...
        let mut small = super::Buffer::new_in(xeme_storage::Allocator::System);
