...
Versions such as `1.2` still use XML 1.0 character rules. The C adapter enables
`Config::allow_invalid_xml_versions` to retain Expat's permissive version syntax;
