...
required=['source/LICENSE-APACHE','source/LICENSE-MIT','source/cpython/LICENSE','expat/COPYING','source/memchr/COPYING','source/memchr/LICENSE-MIT','source/memchr/UNLICENSE']
