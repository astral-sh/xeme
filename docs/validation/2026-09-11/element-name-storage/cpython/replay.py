...
cli.add_argument('--root',type=Path,default=Path('/tmp/oriole-suffix-element-names-python-study'))
...
original=Path('/tmp/oriole-suffix-element-names-python-study')/args.mode
pins={};aliases=[]
def read(p):
