"""Portable arithmetic/semantic replay of the three retained PGO native JSON records.
...
parser.add_argument('--evidence-root',type=Path,required=True,
                    help='Directory containing pgo/native-screen')
...
logical_root=Path('/tmp/oriole-coordinate-checkpoint-guards-native-study')
...
assert result['totals']=={'workers':672,'samples':106176}
