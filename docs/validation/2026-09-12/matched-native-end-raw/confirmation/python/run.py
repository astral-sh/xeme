...
adaptation = json.loads(Path('/tmp/oriole-matched-native-end-raw-study/python/adaptation.json').read_text())
...
phase = sys.argv[1]
common = ['--kind', 'python', '--build', '/tmp/oriole-matched-native-end-raw-study/python/consumers/build.json', '--input', '/home/dev-user/code/oss/oriole/benchmarks/projects/corpus-manifest.json', '--output', str(out / 'screen')]
if phase == 'prepare':
    jobs = [
