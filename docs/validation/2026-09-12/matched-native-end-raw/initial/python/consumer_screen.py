"""Matched native End raw range normal CPython screen with separate correctness and timing phases."""
...
def main() -> int:
    ...
    if set(variants) != set(ENGINES):
        parser.error("Expected selected raw-view control, Matched native End raw range candidate and Expat engines")
    files = [
