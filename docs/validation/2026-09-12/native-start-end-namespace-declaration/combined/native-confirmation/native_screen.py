"""Fixed three-engine matched Start + End + namespace + declaration composition native screen."""
...
root = Path('/tmp/oriole-native-start-end-namespace-declaration-confirmation/native')
...
libraries = {'control': Path('/tmp/oriole-core-owned-text-raw-study/normal/liboriole_expat.so'),
             'candidate': Path('/tmp/oriole-native-start-end-namespace-declaration-study/normal/liboriole_expat.so'),
