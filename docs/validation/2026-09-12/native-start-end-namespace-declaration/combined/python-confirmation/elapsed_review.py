...
D=Path('/tmp/oriole-native-start-end-namespace-declaration-study/python');C=Path('/tmp/oriole-native-start-end-namespace-declaration-confirmation/python');S=C/'screen';original=C
