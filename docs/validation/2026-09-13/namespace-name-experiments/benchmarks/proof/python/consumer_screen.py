"""Planned namespaced-start normal CPython screen with separate correctness and timing phases."""
...
def main() -> int:
    ...
    if set(variants) != set(ENGINES):
        parser.error("Expected qualified c3e65339 control, Planned namespaced-start candidate and Expat engines")
    files = [
