...
//! Expat runs in a persistent separate process, never in Oriole's symbol namespace.
...
impl Oracle {
    fn new() -> Self {
        let executable = std::env::var_os("ORIOLE_EXPAT_ORACLE")
            .expect("set ORIOLE_EXPAT_ORACLE to the separately linked Expat 2.8.4 oracle");
